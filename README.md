...
Pay command sends CloudCoin from your SkyWallet to a remote skywallet. 
In order to transfer you need to tell the program amount of CloudCoins, the name of the destination skywallet and the memo.
You can specify the full path of the ID coin if it is not put in your ID folder.
The function will query the TXT record of the skywallet in order to find a Merchant URL there. This URL will be called upon a successful transfer.
If the transfer failed the URL wouldn't be called. It also requires a 32-hex GUID of the transaction which must be generated by the caller

The function might call break_in_bank if there is not enough Change in your Skywallet.


format: ./skywallet_connect pay <amount of coins to transfer> <guid> <destination_skywallet> <memo> <path to ID coin>
 
Example:

```console
$ ./skywallet_connect pay 2 cc1481595900c736662a6dc40061fdbd merchant.skywallet.cc "my memo" /home/user/my.skywallet.cc.stack
{"amount_sent":2,"Message":"CloudCoins sent","Status":"success"}
```

RAIDA Mail Example:
```console
$ ./skywallet_connect pay 250 ae2481595900c736662a6dc40061fd34 payments.raidamail.com "alex.account" /home/user/raidatech.skywallet.cc.stack
{"amount_sent":250,"Message":"CloudCoins sent","Status":"success"}
...
25: Invalid Receipt ID
26: Invalid Skywallet Owner
27: There is more than one CloudCoin in the stack file
28: Failed to break coin in Bank
29: Failed to write a local file
30: Failed to parse config
31: Invalid GUID
32: Coin already exists
33: Internal Error
34: Failed to get Tickets
35: Coins sent successfully but informing the Merchant failed
36: DNS Resolving Error
37: Invalid URL Format
38: HTTP Error while doing external request to Merchant
```
